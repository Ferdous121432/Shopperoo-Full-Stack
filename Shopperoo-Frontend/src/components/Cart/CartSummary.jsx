    ...
    <div className="flex flex-col px-20 pt-4 pb-20 mx-auto w-full bg-orange-50 max-md:px-5 max-md:mt-10">
      ...
      <div className="flex gap-5 justify-between mt-16 max-md:mt-10">
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-8 text-xl font-medium text-yellow-600">{total}</div>
        </div>
      </div>
      <Link to="/checkout" className="px-14 py-4 mt-11 mr-2.5 ml-3 text-xl text-black rounded-2xl border border-black border-solid max-md:px-5 max-md:mt-10 max-md:ml-2.5">
        Check Out
      </Link>
    </div>
  );
