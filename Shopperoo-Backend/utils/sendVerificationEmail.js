...
async function getAccessToken() {
  ...
  // After the user authorizes the app, you will get a code
...
const sendVerificationEmail = async function (newUser, link) {
  ...
  const mailOptions = {
    ...
    html: generateVerificationMail(newUser, link),
  };

  await transporter.sendMail(mailOptions);
};

const generateVerificationMail = (user, link) => {
  return `
        <!DOCTYPE html>
        <html lang="en">
        <head>
                        ...
                        <title>Welcome to Shopperoo</title>
                        <style>
                                                        .footertext {
                                                                                        font-size: 12px;
                                                        }
                        ...
                        <div style="display: flex; align-items: center; justify-content: center; flex-direction: column; margin-top: 1.25rem; font-family: Nunito, sans-serif">
                                                        <section style="max-width: 42rem; background-color: #fff;">
                                                                                        ...
                                                                                        <main style="text-align: start; padding-left: 20px; padding-right: 20px;">
                                                                                                                        <p>
                                                                                                                                                        Hey <span style="font-weight: bold;">${user.firstName}</span>, We're glad you are here!
                                                                                                                        </p>
                                                                                                                        <p style="margin-top: 10px;">
                                                                                                                                                        You’re joining an amazing community of shoppers at <span style="font-weight: bold;">Shopperoo</span>. You'll be the first to hear about updates on new products, exclusive deals, and much more. If you’re interested in learning more about our offerings or need help with your orders, feel free to contact our support team at any time. We’re always here to help you in any way we can.
                                                                                                                        </p>
                                                                                                                        <a href="${link}">
                                                                                        ...
                                                                                        <p style="padding-left: 1.25rem; padding-right: 1.25rem; margin-top: 2rem;">
                                                                                                                        This email was sent from <a href="mailto:support@shopperoo.com" alt="support@shopperoo.com" target="_blank">support@shopperoo.com</a>. If you'd rather not receive this kind of email, you can <a href="#">unsubscribe</a> or <a href="#">manage your email preferences</a>.
                                                                                        </p>
                                                                                        <footer style="margin-top: 2rem;">
                                                                                                                        <div style="background-color: rgba(209, 213, 219, 0.6); height: 200px; display: flex; flex-direction: column; gap: 1.25rem; justify-content: center; align-items: center;">
                                                                                                                                                        <div style="text-align: center; display: flex; flex-direction: column; gap: 0.75rem;">
                                                                                                                                                                                        ...
                                                                                                                                                                                        <a href="tel:+1-800-123-4567" style="color: #4b5563;" alt="+1-800-123-4567">
                                                                                                                                                                                                                        +1-800-123-4567
                                                                                                                                                                                        </a>
                                                                                                                                                                                        <a href="mailto:support@shopperoo.com" style="color: #4b5563;" alt="support@shopperoo.com">
                                                                                                                                                                                                                        support@shopperoo.com
                                                                                                                                                                                        </a>
                                                                                                                                                        </div>
                                                                                                                                                        <div style="display: flex; align-items: center; justify-content: center; gap: 0.75rem;">
                                                                                                                                                                                        <a href="#_">
                                                                                                                                                                                                                        <svg stroke="currentColor" fill="gray" stroke-width="0" viewBox="0 0 16 16" height="18" width="18" xmlns="http://www.w3.org/2000/svg">
                                                                                                                                                                                                                                                        <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"></path>
                                                                                                                                                                                                                        </svg>
                                                                                                                                                                                        </a>
                                                                                                                                                                                        <a href="#_">
                                                                                                                                                                                                                        <svg stroke="currentColor" fill="gray" stroke-width="0" viewBox="0 0 1024 1024" height="18" width="18" xmlns="http://www.w3.org/2000/svg">
                                                                                                                                                                                        ...
                                                                                                                                                                                        <a href="#_">
                                                                                                                                                                                                                        <svg stroke="currentColor" fill="gray" stroke-width="0" viewBox="0 0 16 16" height="16" width="16" xmlns="http://www.w3.org/2000/svg">
                                                                                                                        ...
                                                                                                                        <div style="background-color: #365cce; padding-top: 10px; padding-bottom: 10px; color: #fff; text-align: center;">
                                                                                                                                                        <p class="footertext">© 2023 Shopperoo. All Rights Reserved.</p>
                                                                                                                        </div>
                                                                                        </footer>
                                                        </section>
                        </div>
